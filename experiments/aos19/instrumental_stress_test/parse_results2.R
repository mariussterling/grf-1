...
setwd("/home/RDC/sterlimq/H:/sterlimq/github/grf-1/experiments/aos19/instrumental_stress_test")

library(xtable)

filenames = list.files("output2", pattern="*", full.names=TRUE)
...
print(xtab, include.rownames = FALSE, include.colnames = TRUE, sanitize.text.function = identity, hline.after = c(-1, -1, 0, 0, 4, 8, 12, 16, 16, 20, 24, 28, 32, 32), file = "simulation_results2.tex")
